...
if ValueError:
    ...
    def banner(cok):
        ...
        _logo_line_4_ = '%s/___/_/_/\\__/\\__/  _/ /_   ║    %s• NAZIRKHAN  •    %s║' % (O, P, O)
                ...
                try:
                    ...
                    if pmu in ('3', '03', '003', 'c'):
                        ...
                        if None in ('1', '01', '001', 'a'):
                            ...
                            return None
                        if None in ('2', '02', '002', 'b'):
                            os.system('xdg-https://www.facebook.com/ajmal.shah41')
                            _cici_dapunta_('%s╚══[ %sKembali %s]%s' % (O, P, O, P))
                            menu_log()
                            return None
                            ...
                            if None:
                                ...
                                if (KeyError, IOError):
                                    ...
                                    if KeyError:
                                        ...
                                        _dapunta_cici_('%s║' % O)
                                        _dapunta_cici_('%s╠══[%s01%s] %sCrack ID Teman/Public' % (O, P, O, P))
